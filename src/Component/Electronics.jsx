...
function Electronics(){
    return(
        ...
        <div className="w-full  lg:w-1/4 justify-start flex flex-col shadow-sm p-2 lg:ms-12 bg-white px-3">
        ...
        <div className="grid grid-cols-1 lg:grid lg:grid-cols-5 lg:gap-7 bg-[#F6F6F6] flex-row  justify-center lg:px-2 lg:top-0  ">
          ...
          return (
            ...
            <div className="flex w-full justify-center relative  ">
              ...
              <div className="bg-white p-7">
                ...
                <button className="border-2 p-1 border-black rounder-sm bottom-0 text-black text-lg font-medium rounded ease-in w-full mt-2 lg:text-sm lg:transition-all lg:duration-300  lg:bg-white  lg:text-black lg:hover:text-white lg:hover:bg-black">
                  Add To Cart
                </button>
              </div>
            </div>
