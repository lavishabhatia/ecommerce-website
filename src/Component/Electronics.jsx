...
function Electronics(){
    return(
        ...
        <div className="w-full md:hidden lg:w-1/4 lg:justify-start lg:flex lg:flex-col shadow-sm p-2 lg:ms-12 bg-white px-3">
            <h1 className="top-2 left-4 text-lg lg:my-3"><b>Electronic</b></h1>
            <div className="flex flex-col gap-2 lg:gap-3">
            <h3 className="font-Open Sans, Roboto, -apple-system, BlinkMacSystemFont, Segoe UI, Oxygen, Ubuntu, Cantarell, Fira Sans, Droid Sans, Helvetica Neue, sans-serif top-5">Wireless Speaker</h3>
            <h3 >Tablet</h3>
            <h3 >Smartphone</h3>
            <h3 >Laptop</h3>
            <h3 >iMac</h3>
        ...
        <div className="grid grid-cols-1 md:grid md:grid-cols-5 md:gap-4 lg:grid lg:grid-cols-5 lg:gap-7 bg-[#F6F6F6] flex-row  justify-center lg:px-2 lg:top-0  ">
          ...
          return (
            ...
            <div className="flex w-full justify-center relative  ">
              ...
              <div className="bg-white p-7">
                ...
                <svg width="24" height="24" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" fill="url(#star-0.979828314219761)" xmlns="http://www.w3.org/2000/svg" stroke="#FFCD4E" class="feather feather-star"><defs><linearGradient id="star-0.979828314219761"><stop offset="1" stop-color="#FFCD4E"></stop><stop offset="1" stop-color="#FFFFFF" stop-opacity="1"></stop></linearGradient></defs><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"></polygon></svg>
                <svg width="24" height="24" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" fill="url(#star-0.979828314219761)" xmlns="http://www.w3.org/2000/svg" stroke="#FFCD4E" class="feather feather-star"><defs><linearGradient id="star-0.979828314219761"><stop offset="1" stop-color="#FFCD4E"></stop><stop offset="1" stop-color="#FFFFFF" stop-opacity="1"></stop></linearGradient></defs><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"></polygon></svg>
                <svg width="24" height="24" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" fill="url(#star-0.979828314219761)" xmlns="http://www.w3.org/2000/svg" stroke="#FFCD4E" class="feather feather-star"><defs><linearGradient id="star-0.979828314219761"><stop offset="1" stop-color="#FFCD4E"></stop><stop offset="1" stop-color="#FFFFFF" stop-opacity="1"></stop></linearGradient></defs><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"></polygon></svg>
                <svg width="24" height="24" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" fill="url(#star-0.979828314219761)" xmlns="http://www.w3.org/2000/svg" stroke="#FFCD4E" class="feather feather-star"><defs><linearGradient id="star-0.979828314219761"><stop offset="1" stop-color="#FFCD4E"></stop><stop offset="1" stop-color="#FFFFFF" stop-opacity="1"></stop></linearGradient></defs><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"></polygon></svg>
                <svg width="24" height="24" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" fill="url(#star-0.15956097530211366)" xmlns="http://www.w3.org/2000/svg" stroke="#FFCD4E" class="feather feather-star"><defs><linearGradient id="star-0.15956097530211366"><stop offset="0" stop-color="#FFCD4E"></stop><stop offset="0" stop-color="#FFFFFF" stop-opacity="1"></stop></linearGradient></defs><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"></polygon></svg>
                </div>
                <button className="border-2 p-1 border-black rounder-sm md:text-[16px] bottom-0 text-black text-lg font-medium rounded ease-in w-full mt-2 lg:text-sm lg:transition-all lg:duration-300  lg:bg-white  lg:text-black lg:hover:text-white lg:hover:bg-black">
                  Add To Cart
                </button>
              </div>
            </div>
