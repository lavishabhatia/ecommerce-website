        ...
        {Electronics_data.map((e) => {
          return (
            ...
            <div className="flex w-full justify-center relative  ">
              ...
              <div className="bg-white p-7 lg:p-3">
                ...
                <p className="text-center bottom-10 text-black text-lg font-medium rounded w-full py-3">
                  <b>{e.cost}</b>
                </p>
                ...
                <button className="border-2 border-black rounded-br-sm  text-black text-lg font-medium rounded flex justify-center p-2 lg:transition-all lg:duration-300 lg:text-sm w-full  lg:bg-white  lg:text-black lg:hover:text-white lg:hover:bg-black">
                  Add To Cart
                </button>
              </div>
            </div>
