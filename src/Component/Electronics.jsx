...
function Electronics(){
    return(
        ...
        <div className="w-full  lg:w-1/4 justify-start flex flex-col shadow-sm p-2 lg:ms-12 bg-white px-3">
            <h1 className="top-3 left-4 text-lg lg:my-3"><b>Electronic</b></h1>
        ...
        <div className="grid grid-cols-1 lg:grid lg:grid-cols-5 lg:gap-7 bg-[#F6F6F6] flex-row  justify-center  lg:px-7">
